...
def nettoyage():
    ...
    df = pd.read_csv(r"dataset/global-data-on-sustainable-energy/global-data-on-sustainable-energy (1).csv")
    ...
    # On ajoute une nouvelle colonne avec les codes des pays pour la carte chloroplete
    country_codes = {
        'Austria': 'AUT',
        'Belgium': 'BEL',
        'Bulgaria': 'BGR',
    ...
    df_UE['Code'] = df_UE['Pays'].map(country_codes)
    ...
    df_UE["Pays"] = df_UE["Pays"].map(correspondance_pays)
